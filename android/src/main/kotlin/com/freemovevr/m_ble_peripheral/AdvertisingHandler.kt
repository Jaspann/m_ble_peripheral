...
import com.freemovevr.m_ble_peripheral.model.KAdvertiseData
import com.freemovevr.m_ble_peripheral.model.KAdvertiseSetting
...
class AdvertisingHandler(context: Context) : MethodCallHandler {
    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        Log.d("MBlePeripheralPlugin", "onMethodCall->${call.method}")
        when (call.method) {
            "startAdvertising" -> {
